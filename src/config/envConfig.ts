...
export const ENV_CONFIG: EnvConfig = {
  ...
  SOCIAL_API_URL: 'https://adilyassar-edulearn-social-microservice.onrender.com/api/v1',
  SOCIAL_SOCKET_URL: 'https://adilyassar-edulearn-social-microservice.onrender.com',
