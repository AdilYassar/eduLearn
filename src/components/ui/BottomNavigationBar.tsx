...
import { House, BookOpen, Book, BotMessageSquare, Video } from 'lucide-react-native';
    ...
    <View style={styles.bottomNavContainer}>
      ...
      >
        <View style={styles.homeIconWrapper}>
          <House 
            size={24} 
            color="#000" 
            fill={currentScreen === 'DashboardScreen' ? "#666" : "transparent"}
          />
        </View>
      </TouchableOpacity>
      ...
      <View style={[styles.otherIconsContainer, { backgroundColor }]}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigate('Ai')}
        >
          <BotMessageSquare size={24} color="#000" />
        </TouchableOpacity>
