  ...
  return (
    ...
    >
      ...
      <View style={styles.subContainer}>
        <View style={[styles.inputContainer, isVoiceMode && styles.voiceModeInput]}>
          <TextInput
            editable={!isVoiceMode}
            multiline
            ref={TextInputRef}
            value={message}
            style={[styles.textinput, isVoiceMode && styles.voiceModeTextInput]}
            placeholder={isVoiceMode ? 'Voice input active...' : 'Message'}
            placeholderTextColor={isVoiceMode ? '#888' : '#000'}
            onChangeText={handleTextChange}
            onContentSizeChange={handleContentSizeChange}
          />
        </View>

        {/* Voice Button - Show if voice is available and initialized */}
        {voiceAvailable && hasPermissions && voiceInitialized && (
          <TouchableOpacity
            style={[
              styles.voiceButton,
              isListening && styles.voiceButtonActive,
              isVoiceMode && styles.voiceButtonListening,
            ]}
